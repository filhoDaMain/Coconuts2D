...
#define PARSER_TRANSFORMOMPONENT_POS_KEY_FLOAT_SEQ "pos"
#define PARSER_TRANSFORMOMPONENT_SCALE_KEY_FLOAT_SEQ "scale"
#define PARSER_TRANSFORMOMPONENT_ROT_KEY_FLOAT "rot"
