...
cp ./build/src/libccn2d.a "$ENV_COCONUTS2D_EXPORT_ENGINE_DIRPATH/$ENV_COCONUTS2D_EXPORT_ENGINE_OUTNAME" 2>/dev/null
cp ./build/src/Coconuts2D "$ENV_COCONUTS2D_EXPORT_EDITOR_STANDALONE_DIRPATH/$ENV_COCONUTS2D_EXPORT_EDITOR_STANDALONE_OUTNAME" 2>/dev/null
